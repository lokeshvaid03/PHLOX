    ...
    <div className=" shadow-md bg-white dark:bg-gray-900 dark:text-white duration-100 relative z-40">
      <div className="bg-primary/40 py-3">
        <div className=" container flex justify-between items-center">
          <div> 
            <a href="#" className=" text-third font-bold text-2xl sm:text-3xl flex gap-2">
              Pholox
            </a>
        ...
        <ul className="sm:flex hidden items-center gap-4">
          {Menu.map((data) => (
            <li key={data.id}>
              <a
                href={data.link}
                className="inline-block px-4 text-secondary hover:text-primary duration-200"
              >
                {data.name}
              </a>
            </li>
          ...
          <li className="group relative cursor-pointer">
            <a href="#" className="text-secondary flex items-center gap-[2px] py-2">
              Our Stores
              <span>
